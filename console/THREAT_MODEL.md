...
|---|---|
| Denied attempts invisible | Every mutation appends its outcome — the denial at the gate, including probes at targets that do not exist. An *authorized* probe that 404s appends nothing: nothing happened, and that caller already held the permission everywhere |
